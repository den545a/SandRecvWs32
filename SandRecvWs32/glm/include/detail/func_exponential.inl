...
#	endif
	...
	struct compute_log2
	{
		...
		{
			GLM_STATIC_ASSERT(std::numeric_limits<T>::is_iec559 || GLM_CONFIG_UNRESTRICTED_FLOAT, "'log2' only accept floating-point inputs. Include <glm/include/gtc/integer.hpp> for integer inputs.");
...
#	include "glm/include/detail/func_exponential_simd.inl"
#endif
